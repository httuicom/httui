...
// --- Per-block settings ---
// Stored in SQLite `block_settings` keyed by (file_path, alias).
// Absent flags are treated as defaults (true for follow_redirects/verify_ssl/encode_url/trim_whitespace; false for history_disabled).
