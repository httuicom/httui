...
// Keymap helper primitives now live in `crate::input::parser`;
// re-exported here so the in-file `mod tests` (`use super::*`)
// keeps resolving `try_motion` & friends (tui-v2 vertical 1, fase 1 p2).
pub(crate) use crate::input::parser::{
